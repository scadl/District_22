...
%ADB% %DEVICE% install D22_UE4-Android-Shipping-armv7-es2.apk
...
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/net.scadsdnd.D22_UE4
@echo.
@echo Installing new data. Failures here indicate storage problems (missing SD card or bad permissions) and are fatal.
%ADB% %DEVICE% push main.4.net.scadsdnd.D22_UE4.obb %STORAGE%/Download/obb/net.scadsdnd.D22_UE4/main.4.net.scadsdnd.D22_UE4.obb
if "%ERRORLEVEL%" NEQ "0" goto Error


%ADB% %DEVICE% shell mkdir %STORAGE%/Android/obb/net.scadsdnd.D22_UE4
%ADB% %DEVICE% shell cp %STORAGE%/Download/obb/net.scadsdnd.D22_UE4/* %STORAGE%/Android/obb/net.scadsdnd.D22_UE4
if "%ERRORLEVEL%" NEQ "0" goto Error
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/net.scadsdnd.D22_UE4
@echo.
